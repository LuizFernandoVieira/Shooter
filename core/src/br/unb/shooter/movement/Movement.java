...
public class Movement {
    ...
    public void update() {
        ...
        if (player.getPositionX() < CAMERA_LEFT - player.getOffsetX()) {
            player.setScreenX(player.getPositionX());
        }

        if (player.getPositionY() < CAMERA_BOTTOM - player.getOffsetY()) {
            player.setScreenY(player.getPositionY());
        }
        
        if (player.getPositionX() > CAMERA_RIGHT - player.getOffsetX()) {
